...
from ..bbox import PseudoSampler,  build_assigner,assign_and_sample, build_bbox_coder
...
def anchor_target_single(
    ...
    labels = anchors.new_full((num_valid_anchors, ),num_classes,dtype=torch.long)
