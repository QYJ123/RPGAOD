...
class CascadeS2ANetDetector(BaseDetector):
    ...
    def forward_train(self,
        ...
        anchors_list, valid_flag_list = self.bbox_head[0].get_anchors(featmap_sizes, img_metas, device=x[0].device)
    ...
    def simple_test(self, img, img_meta, rescale=False):
        ...
        bbox_results = [
           arb2result(det_bboxes, det_labels, self.bbox_head[self.num_stages - 1].num_classes,bbox_type)
